...
const db = {
    users: {
        get: ()=>getItem('users') || [],
        set: (data)=>setItem('users', data)
    },
    currentUser: {
        get: ()=>getItem('currentUser'),
        set: (data)=>setItem('currentUser', data),
        clear: ()=>{
    ...
    reports: {
        get: ()=>getItem('reports') || [],
        set: (data)=>setItem('reports', data)
    },
    policyFeedback: {
        get: ()=>getItem('policyFeedback') || [],
        set: (data)=>setItem('policyFeedback', data)
    },
    discussions: {
        get: ()=>getItem('discussions') || [],
        set: (data)=>setItem('discussions', data)
    },
    communityTips: {
        get: ()=>getItem('communityTips') || [],
        set: (data)=>setItem('communityTips', data)
    },
    utils: {
        simpleHash
    }
...
const AuthProvider = ({ children })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$localStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["initializeDb"])();
            const currentUser = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$localStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].currentUser.get();
            if (currentUser) {
                setUser(currentUser);
            }
            setLoading(false);
    ...
    const login = (loggedInUser)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$localStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].currentUser.set(loggedInUser);
    ...
    const logout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[logout]": ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$localStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].currentUser.clear();
            setUser(null);
            router.push('/login');
        }
    }["AuthProvider.useCallback[logout]"], [
    ...
    const updateUser = (updatedUser)=>{
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$localStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].currentUser.set(updatedUser);
        setUser(updatedUser);
        // Also update the user in the main users list
        const allUsers = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$localStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].users.get();
        const userIndex = allUsers.findIndex((u)=>u.id === updatedUser.id);
        if (userIndex !== -1) {
            allUsers[userIndex] = updatedUser;
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$localStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["db"].users.set(allUsers);
        }
    };
...
_s1(AuthProvider, "0HlYBi7+Jvs8+10rT+lKQHtOhVk=", false, function() {
    return [
...
//# sourceMappingURL=src_ed62ef91._.js.map